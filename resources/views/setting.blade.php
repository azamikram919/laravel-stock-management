                                            ...
                                            <div id="addBrand" class="tab-pane fade">
                                                ...
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="name" value="" class="span6 "
                                                                   required/></td>
                                                    </tr>
                                                ...
                                                <button type="submit" class="btn btn-primary btn-sm">SAVE INFORMATION
                                                </button>
                                                {!!Form::close()!!}
                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <label style="margin-bottom:0px;" class="switch">
                                                                <a href="{{URL::to('/unpublished-brand/'.$v_brand->ID)}}"><input
                                                                            id="switchMenu" type="checkbox" checked>
                                                            ...
                                                            ?>
                                                            <label style="margin-bottom:0px;" class="switch">
                                                                <a href="{{URL::to('/published-brand/'.$v_brand->ID)}}"><input
                                                                            id="switchMenu" type="checkbox">
                                                                    <span class="slider round"></span></a>
                                                            </label>
                                                            <?php } ?>
                                                        </td>
                                                        <td>
                                                            <div class="form-actions">
                                                                <button type="submit" class="btn alert-danger btn-sm">
                                                                    SAVE
                                                                </button>
                                                            </div>
                                                        </td>
                                            ...
                                            <div id="manageStyle" class="tab-pane fade in active">
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" id="stylename" value="" class="span6 "
                                                                   required/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <button type="submit" onclick="saveStyle();"
